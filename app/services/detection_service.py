...
BUGFIX: Re-added db_session_factory to log detection events.
"""
import asyncio
import uuid
...
# --- THIS IS THE FIX ---
# We import AsyncSessionFactory directly from its source file, database.py,
# instead of from the top-level models package.
...
class AsyncDetectionService:
    ...
    def __init__(
        ...
        conveyor_settings,
        db_session_factory # This is now required
    ):
